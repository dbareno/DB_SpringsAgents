...
def query_material_properties_tool(
    ...
    Returns:
        JSON string with a list of material candidate dicts.
    """
    try:
        ...
        # ── Scoring: rank by (yield_strength / cost) — higher is better ───
        df = df.copy()
        df["score"] = df["yield_strength_mpa"] / df["cost_usd_per_kg"]
